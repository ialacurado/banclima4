...
const getProjectData = (id: string) => {
  return {
    ...
    status: "Ativo - Projeto Certificado Gold Standard",
...
const ProjectDetailView: React.FC<ProjectDetailViewProps> = ({ projectId }) => {
  ...
  return (
    <div className="space-y-6">
      {/* Retângulo azul com nome do projeto */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-1">
          <Card className="overflow-hidden">
            <div className="bg-[#0e7cb4] flex justify-center items-center p-6">
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <h3 className="font-medium mb-2">Atributos do Projeto</h3>
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-green-500" />
                      <span>Desenvolvedor: {project.developer}</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-green-500" />
                      <span>Metodologia: {project.methodology}</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-green-500" />
                    ...
                    <div className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-green-500" />
                      <span>Escala: {project.scale}</span>
                    </div>
                  </div>
                </div>
                
                <div>
                  <h3 className="font-medium mb-2">Período de Crédito</h3>
                  <p className="text-gray-700 mb-4">{project.creditPeriod}</p>
                  
                  <h3 className="font-medium mb-2">Créditos Anuais Estimados</h3>
                  <p className="text-gray-700">{project.annualCredits} tCO₂e</p>
                </div>
              </div>
